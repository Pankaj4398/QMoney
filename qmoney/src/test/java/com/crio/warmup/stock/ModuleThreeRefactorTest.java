...
class ModuleThreeRefactorTest {
  ...
  private String googlQuotes = "[{\"date\":\"2019-01-02T00:00:00.000Z\",\"close\":1054.68,"
          + "\"high\":1060.79,\"low\":1025.28,\"open\":1027.2,\"volume\":1593395,\"adjClose\":"
          + "1054.68,"
          ...
          + "\"close\":1348.49,\"high\":1080.0,\"low\":1036.86,\"open\":1042.56,\"volume\":"
          + "2301428,"
          + "\"adjClose\":1078.07,\"adjHigh\":1080.0,\"adjLow\":1036.86,\"adjOpen\":1042.56,\""
          + "adjVolume"
  ...
  public void fetchCandles() throws JsonProcessingException {
    ...
    List<Candle> candleList = PortfolioManagerApplication
        .fetchCandles(trade, LocalDate.parse("2020-01-05"),
